...
<form action="index.php?option=com_alphauserpoints" method="post" name="adminForm" id="adminForm" class="form-validate">
	<table class="adminlist" cellpadding="1">
		...
		<?php		
			...
			//$img = '<img src="images/tick.png" border="0" alt="'. JText::_('AUP_CONFIRMED') .'" /></a>';
			
			$img = '<img src="components/com_alphauserpoints/assets/images/tick.png" border="0" alt="'. JText::_('AUP_CONFIRMED') .'" />';
