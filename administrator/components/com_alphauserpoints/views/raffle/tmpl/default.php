	...
	<table class="adminlist" cellpadding="1">
		...
		<?php
			...
			for ($i=0, $n=count( $this->raffle ); $i < $n; $i++)
			{
				...
				$imgA 	 = $row->inscription ? JURI::base(true).'/components/com_alphauserpoints/assets/images/tick.png':JURI::base(true).'/components/com_alphauserpoints/assets/images/publish_x.png'  ;
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center">
					<?php echo getFormattedPoints($row->pointstoparticipate); ?>
				</td>
				<td align="center">
					<?php 
					if ( !$row->inscription ) {
				...
				<td align="center">
					...
					if ( $row->raffledate == $nullDate ) {
						...
						echo JHTML::_('date',  $row->raffledate,  JText::_('DATE_FORMAT_LC2')) . '<br />' . nicetime($row->raffledate, 0);
					}
					?>
				</td>
				<td align="center">
