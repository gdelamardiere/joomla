...
<form action="index.php?option=com_alphauserpoints" method="post" name="adminForm" id="raffle-form" class="form-validate">
<div class="width-100 fltrt">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td><fieldset id="jform_inscription" class="radio">	
		...
		<tr>
		  ...
		  <td><fieldset id="jform_multipleentries" class="radio">	
		...
		<tr>
			...
			<td><fieldset id="jform_removepointstoparticipate" class="radio">	
	...
	<table class="admintable" id="rafflesystemexpand1" <?php if ( $row->rafflesystem==0 || $row->rafflesystem==2 || $row->rafflesystem==3 ) echo "style=\"display:none\""; ?>>
		...
		<tr>
			...
			<td><fieldset id="jform_sendcouponbyemail" class="radio">		
