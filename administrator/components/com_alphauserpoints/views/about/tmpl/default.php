...
<table class="noshow">
	<tr>
		...
		<p><br />
		  AlphaUserPoints is the first component for Joomla 1.6.x and Joomla 1.7.x and Joomla 2.5.x created to  provide a method for users to accumulate points for
