...
<form action="index.php" method="post" name="adminForm" autocomplete="off">
		<fieldset>
			<div style="float: right">
				<button type="submit" onclick="Joomla.submitform('savecustompoints', this.form);window.top.location.reload(true);document.location.reload(true);">
					<?php echo JText::_( 'Save' );?></button>
				<!--<button type="submit" onclick="window.parent.SqueezeBox.close();window.top.location='index.php?option=com_alphauserpoints&task=showdetails&cid=<?php echo $this->cid; ?>&name=<?php echo $this->name; ?>';window.top.location.reload(true);history.go(0);window.top.location.reload(true);">
					<?php echo JText::_( 'Save' );?></button>-->
