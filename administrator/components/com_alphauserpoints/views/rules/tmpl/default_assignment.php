				...
				<ul class="menu-links">
					...
					/*
						...
						*/
							...
							$checked = in_array($link->value, $menuSelected ) ? ' checked="checked"' : '';
						//endif;
					?>
					<li class="menu-link">
						...
						<input type="checkbox" class="chkbox <?php echo $chkbox_class; ?>" name="content_items[]" value="<?php echo (int) $link->value;?>" id="link<?php echo (int) $link->value;?>"<?php echo $checked;?>/>
