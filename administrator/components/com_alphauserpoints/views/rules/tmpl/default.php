	...
	<table class="adminlist" cellpadding="1">
		...
		<?php
			...
			for ($i=0, $n=count( $this->rules ); $i < $n; $i++)
			{
				...
				$locked = $row->blockcopy ? '<img src="'.JURI::base(true).'/components/com_alphauserpoints/assets/images/locked.png" alt="'.JText::_( 'AUP_THISRULECANTBECOPIED' ).'" />' : '';
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center">
					...
					switch ( $row->plugin_function ) {
						...
						case 'sysplgaup_winnernotification':
						case 'sysplgaup_archive':
							echo  "<img src=\"".JURI::base(true)."/components/com_alphauserpoints/assets/images/checked_out.png\" border=\"0\" title=\"".JText::_('AUP_NOT_AVAILABLE')."\" alt=\"".JText::_('AUP_NOT_AVAILABLE')."\" /></a>";
							break;						
						default:
							echo $autoapproved;
					} 
