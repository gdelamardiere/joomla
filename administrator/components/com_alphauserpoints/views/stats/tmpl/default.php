...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		//if (task == 'cpanel' || document.formvalidator.isValid(document.id('stats-form'))) {
			Joomla.submitform(task, document.getElementById('stats-form'));
		//}
		//else {
...
<thead>
 ...
 <tr>
	...
	<td><?php echo getFormattedPoints($this->communitypoints) . " " . strtolower(JText::_( 'AUP_POINTS' )) ; ?></td>
 </tr>
 <tr>
...
<br /><br />
<form action="index.php" method="post" name="adminForm" id="stats-form" class="form-validate">
  ...
  <tbody>
	...
	?>
			<tr>
			  ...
			  <td><?php echo getFormattedPoints($row->sumpoints) . "&nbsp;&nbsp;<font color=\"#CCCCCC\">(" . $showpercent . ")</font>";?></td>
			</tr>
			<?php
	}
	?>
  ...
  <tbody>
	...
	?>
			<tr>
			  ...
			  <td><?php echo getFormattedPoints($row->sumpoints);?></td>
			</tr>
			<?php
	}
	?>
