...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		//if (task == 'cpanel' || task == 'cancelrule' || document.formvalidator.isValid(document.id('maxpoints-form'))) {
			Joomla.submitform(task, document.getElementById('maxpoints-form'));
		//}
		//else {
...
<form action="index.php?option=com_alphauserpoints" method="post" name="adminForm" id="maxpoints-form" class="form-validate">
